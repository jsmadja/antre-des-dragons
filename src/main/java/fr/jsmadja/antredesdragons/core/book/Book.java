...
public class Book {
    ...
    private final Map<Integer, Chapter> chapters = new HashMap<>() {{
        ...
        put(13, new Chapter13().withNumber(13));
        ...
        put(19, new Chapter19().withNumber(19));
        ...
        put(25, new Chapter25().withNumber(25));
        ...
        put(39, new Chapter39().withNumber(39));
        ...
        put(46, new Chapter46().withNumber(46));
        put(47, new Chapter47().withNumber(47));
        ...
        put(57, new Chapter57().withNumber(57));
        ...
        put(78, new Chapter78().withNumber(78));
        ...
        put(84, new Chapter84().withNumber(84));
        put(85, new Chapter85().withNumber(85));
        put(86, new Chapter86().withNumber(86));
        ...
        put(94, new Chapter94().withNumber(94));
        ...
        put(99, new Chapter99().withNumber(99));
        ...
        put(104, new Chapter104().withNumber(104));
        ...
        put(137, new Chapter137().withNumber(137));
        put(138, new Chapter138().withNumber(138));
        put(139, new Chapter139().withNumber(139));

        put(140, new Chapter140().withNumber(140));
        put(141, new Chapter141().withNumber(141));
        ...
        put(151, new Chapter151().withNumber(151));
        ...
        put(160, new Chapter160().withNumber(160));
        put(161, new Chapter161().withNumber(161));
        put(162, new Chapter162().withNumber(162));
        put(163, new Chapter163().withNumber(163));
        put(164, new Chapter164().withNumber(164));
        put(165, new Chapter165().withNumber(165));
        put(166, new Chapter166().withNumber(166));
        put(167, new Chapter167().withNumber(167));
        put(168, new Chapter168().withNumber(168));
        put(169, new Chapter169().withNumber(169));

        put(170, new Chapter170().withNumber(170));
        put(171, new Chapter171().withNumber(171));
        put(172, new Chapter172().withNumber(172));
        put(173, new Chapter173().withNumber(173));

        put(200, new Chapter200().withTitle("Le triomphe de Pip"));
        put(201, new Chapter201().withTitle("Nouvelles Aventures"));
    }};
