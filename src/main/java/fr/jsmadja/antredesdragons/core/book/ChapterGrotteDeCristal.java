...
public class ChapterGrotteDeCristal extends ManualChoiceChapter {
    ...
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(Path.builder().description("J'ai fait le Château des ténèbres").chapter(1).build(),
                Path.builder().description("Je n'ai pas fait le Chateau des ténèbres").chapter(2).build());
    }
}
