...
public class Chapter107 extends ManualChoiceChapter {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("C'est une énigme stupide").chapter(116).build(),
                Path.builder().description("Je ne sais pas").chapter(121).build(),
                Path.builder().description("L'une de ses pattes se ressemble").chapter(122).build()
        );
    }
