...
public class Chapter9 extends ManualChoiceChapter {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Partager mon repas").chapter(36).build(),
                Path.builder().description("Refuser de partager mon repas").chapter(22).build()
        );
    }
