...
public class Chapter116 extends GoNextChapter {
    @Override
    ...
    public String getText() {
        return "Aussitôt, le couvercle du cercueil se rabat, et une mince silhouette d'une mortelle " +
                "pâleur en tenue de soirée et longue cape noire en bondit avec une effrayante célérité. " +
                "Cette créature a des yeux roses et ses canines supérieures chevauchent sa lèvre inférieure. Qui plus est, elle a l'air furieux. " +
