...
public class Chapter162 extends GoNextChapter {
    @Override
    ...
    public String getText() {
        return "Regardez, Pip ! Il y a un Globe au fond du coffre ! Il repose sur un coussin de velours " +
                "pourpre, à côté d'une petite plaque de cuivre polie portant une inscription. Penchez vous pour la déchiffrer !\n" +
                ...
                "pourrez rencontrer, avant d'affronter le monstre de bronze. Vous prenez donc délicatement le Globe, et vous le rangez avec soin dans votre sac, vous demandant qui en " +
