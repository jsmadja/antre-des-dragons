...
public class Chapter19 extends ManualChoiceChapter {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Combattre avec des armes").chapter(15).build(),
                Path.builder().description("Utiliser la magie").chapter(12).build(),
                Path.builder().description("Utiliser une arme magique").chapter(32).build()
        );
    }
