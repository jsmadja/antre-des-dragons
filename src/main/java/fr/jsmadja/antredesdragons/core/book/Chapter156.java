...
public class Chapter156 extends ManualChoiceChapter {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Rabattre le moraillon et soulever le couvercle").chapter(171).build(),
                Path.builder().description("Manœuvrer le rubis").chapter(165).build(),
                Path.builder().description("Forcer la serrure").chapter(169).build()
        );
    }
