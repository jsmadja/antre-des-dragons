...
public class Chapter126 extends ManualChoiceChapter {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Ouvrir les coffres 1 et 3").chapter(135).build(),
                Path.builder().description("Ouvrir les coffres 1 et 2").chapter(140).build(),
                Path.builder().description("Ouvrir les coffres 2 et 3").chapter(146).build(),
                Path.builder().description("Ouvrir le coffre 1 et la cassette").chapter(143).build(),
                Path.builder().description("Ouvrir le coffre 2 et la cassette").chapter(150).build(),
                Path.builder().description("Ouvrir le coffre 3 et la cassette").chapter(129).build()
        );
    }
