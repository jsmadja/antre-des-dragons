...
public class Page165 extends ManualChoicePage {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Attaquer les Formes").page(157).build(),
                Path.builder().description("Attendre").page(168).build()
        );
    }
