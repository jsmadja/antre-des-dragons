...
public class Chapter160 extends RollAndGoChapter {
    @Override
    protected List<DiceWay> getDiceWays(Pip pip) {
        return List.of(
                DiceWay.builder().from(1).to(9).chapterNumber(ChapterNumber.chapter(163)).build(),
                DiceWay.builder().from(10).to(12).chapterNumber(ChapterNumber.chapter(166)).build()
        );
    }
