...
public class Page139 extends ManualChoicePage {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Aller vers le nord-ouest").page(141).build(),
                Path.builder().description("Aller vers le nord").page(151).build(),
                Path.builder().description("Aller vers le nord-est").page(154).build()
        );
    }
