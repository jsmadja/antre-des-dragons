...
public class Chapter25 extends ManualChoiceChapter {
    @Override
    ...
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(Path.builder().description("Aller au nord").chapter(62).build(), Path.builder().description("Aller au nord-est").chapter(84).build());
    }
