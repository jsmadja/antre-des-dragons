...
public class Page134 extends ManualChoicePage {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        Paths paths = new Paths(
                Path.builder().description("Poussez les trois leviers vers le haut").page(142).build(),
                Path.builder().description("Rabattez tous les leviers vers le bas").page(145).build(),
                Path.builder().description("Poussez un levier vers le haut et deux vers le bas").page(148).build(),
                Path.builder().description("Poussez deux leviers vers le haut et un vers le bas").page(149).build()
        );
        if (pip.has(MINOTAUR_KEY)) {
            paths.add(
                    Path.builder().description("Mettre la clef et poussez les trois leviers vers le haut").page(139).build(),
                    Path.builder().description("Mettre la clef et rabattez les trois leviers vers le bas").page(141).build(),
                    Path.builder().description("Mettre la clef et poussez un levier vers le haut et deux vers le bas").page(144).build(),
                    Path.builder().description("Mettre la clef et poussez deux leviers vers le haut et un vers le bas").page(147).build()
            );
        }
        return paths;
    }
