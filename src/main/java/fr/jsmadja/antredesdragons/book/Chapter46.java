...
public class Chapter46 extends ManualChoiceChapter {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Faire confiance à l'arbre").chapter(77).build(),
                Path.builder().description("Ne pas faire confiance à l'arbre").chapter(11).build()
        );
    }
