...
public class Chapter80 extends ManualChoiceChapter {
    @Override
    ...
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(Path.builder().description("Retourner à la carte").chapter(10).build(), Path.builder().description("S'engager dans le couloir").chapter(25).build());
    }
}
