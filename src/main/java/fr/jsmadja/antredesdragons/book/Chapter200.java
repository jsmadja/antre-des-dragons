...
public class Chapter200 extends GoNextChapter {
    @Override
    ...
    public String getText() {
        return "Vint donc un jour en Avalon où deux étranges personnages dépenaillés réussirent " +
                ...
                "ce qui leur permit d'éviter des endroits aussi épouvantables que le village de la Pierrequi-Mue. Il leur fallut néanmoins plusieurs jours pour revenir sur leurs pas et regagner " +
