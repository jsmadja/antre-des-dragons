...
public class Page154 extends ManualChoicePage {
    @Override
    public Paths getPossiblesPath(Pip pip) {
        return new Paths(
                Path.builder().description("Lire le parchemin").page(170).build(),
                Path.builder().description("Ouvrir le coffre").page(156).build()
        );
    }
